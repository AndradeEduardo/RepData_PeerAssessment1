...
actData$fwDay <- factor(weekdays(actData$date), labels = c("weekday", "weekday", "weekend", "weekend", "weekday", "weekday", "weekday"))

#checking if factoring is ok
View(data.frame(actData$fwDay, weekdays(actData$date)))
